...
class SymbolsReferenceView extends StatelessWidget {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            buildTab([
              symbolItem(const NoteValueWidget(noteType: 'whole', size: 50),
                  'Whole Note (4 beats)'),
              symbolItem(const NoteValueWidget(noteType: 'half', size: 50),
                  'Half Note (2 beats)'),
              symbolItem(const NoteValueWidget(noteType: 'quarter', size: 50),
                  'Quarter Note (1 beat)'),
              symbolItem(const NoteValueWidget(noteType: 'eighth', size: 50),
                  'Eighth Note (½ beat)'),
              symbolItem(const NoteValueWidget(noteType: 'sixteenth', size: 50),
                  'Sixteenth Note (¼ beat)'),
            ]),
            buildTab([
              symbolItem(const RestWidget(restType: 'whole', size: 50),
                  'Whole Rest (4 beats)'),
              symbolItem(const RestWidget(restType: 'half', size: 50),
                  'Half Rest (2 beats)'),
              symbolItem(const RestWidget(restType: 'quarter', size: 50),
                  'Quarter Rest (1 beat)'),
              symbolItem(const RestWidget(restType: 'eighth', size: 50),
                  'Eighth Rest (½ beat)'),
              symbolItem(const RestWidget(restType: 'sixteenth', size: 50),
                  'Sixteenth Rest (¼ beat)'),
            ]),
            buildTab([
              symbolItem(const ClefWidget(clefType: 'treble', size: 50),
                  'Treble Clef'),
              symbolItem(
            ...
            buildTab([
              symbolItem(const DynamicsWidget(dynamicType: 'pp', size: 50),
                  'Pianissimo (very soft)'),
              symbolItem(const DynamicsWidget(dynamicType: 'p', size: 50),
                  'Piano (soft)'),
              symbolItem(const DynamicsWidget(dynamicType: 'mp', size: 50),
                  'Mezzo-piano (moderately soft)'),
              symbolItem(const DynamicsWidget(dynamicType: 'mf', size: 50),
                  'Mezzo-forte (moderately loud)'),
              symbolItem(const DynamicsWidget(dynamicType: 'f', size: 50),
                  'Forte (loud)'),
              symbolItem(const DynamicsWidget(dynamicType: 'ff', size: 50),
                  'Fortissimo (very loud)'),
              symbolItem(const DynamicsWidget(dynamicType: 'sfz', size: 50),
            ...
            buildTab([
              ...
              symbolItem(const KeySignatureWidget(sharps: 1, size: 50),
                  'G Major / E Minor (1 sharp)'),
              symbolItem(const KeySignatureWidget(sharps: 2, size: 50),
                  'D Major / B Minor (2 sharps)'),
              symbolItem(const KeySignatureWidget(sharps: 3, size: 50),
                  'A Major / F# Minor (3 sharps)'),
              symbolItem(const KeySignatureWidget(sharps: 4, size: 50),
                  'E Major / C# Minor (4 sharps)'),
              symbolItem(const KeySignatureWidget(sharps: 5, size: 50),
                  'B Major / G# Minor (5 sharps)'),
              symbolItem(const KeySignatureWidget(flats: 1, size: 50),
                  'F Major / D Minor (1 flat)'),
              symbolItem(const KeySignatureWidget(flats: 2, size: 50),
                  'Bb Major / G Minor (2 flats)'),
              symbolItem(const KeySignatureWidget(flats: 3, size: 50),
                  'Eb Major / C Minor (3 flats)'),
              symbolItem(const KeySignatureWidget(flats: 4, size: 50),
                  'Ab Major / F Minor (4 flats)'),
              symbolItem(const KeySignatureWidget(flats: 5, size: 50),
                  'Db Major / Bb Minor (5 flats)'),
            ]),
            buildTab([
              symbolItem(const MeasureWidget(barlineType: 'single', size: 50),
                  'Single Barline'),
              symbolItem(const MeasureWidget(barlineType: 'double', size: 50),
                  'Double Barline'),
              symbolItem(const MeasureWidget(barlineType: 'final', size: 50),
  ...
  Widget buildTab(List<Widget> items) {
    return ListView(
  ...
  Widget symbolItem(Widget symbol, String name) {
    return Padding(
